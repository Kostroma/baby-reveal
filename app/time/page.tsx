...
export default function TimePage(){
  ...
  return <main className="min-h-screen px-6 pb-28 flex flex-col items-center justify-center text-center">
    <div className="max-w-md w-full space-y-8">
      <h1 className="text-4xl font-bold">Время рождения?</h1>
    ...
    <BottomButton onClick={()=>{localStorage.setItem("time",String(hour));localStorage.setItem("timeTickets",String(tickets));if (tickets > total) return; localStorage.setItem("remainingTickets",String(remaining));router.push("/eyes");}}>Next</BottomButton>
  </main>
}
