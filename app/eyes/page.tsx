...
export default function EyesPage(){
  ...
  return <main className="min-h-screen px-6 pb-28 flex flex-col items-center justify-center text-center">
    <div className="max-w-md w-full space-y-8">
      <h1 className="text-4xl font-bold">Цвет глаз?</h1>
    ...
    <BottomButton onClick={()=>{localStorage.setItem("eyes",selected);localStorage.setItem("eyesTickets",String(tickets));if (tickets > total) return; localStorage.setItem("remainingTickets",String(remaining));router.push("/hair");}}>Next</BottomButton>
  </main>
}
