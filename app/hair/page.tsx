...
export default function HairPage() {
  ...
  const options = [
    ...
    { value: "Ginger", label: t.hairGinger },
  ...
  return (
    <main className="min-h-screen px-6 pb-28 flex flex-col items-center justify-center text-center">
      <div className="max-w-md w-full space-y-8">
        <h1 className="text-4xl font-bold">{t.hair}</h1>

        <p className="text-gray-500">{t.hairNote}</p>
      ...
      <BottomButton
        onClick={() => {
          localStorage.setItem("hair", selected);
          localStorage.setItem("hairTickets", String(tickets));
