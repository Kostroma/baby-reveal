mkdir -p app/summary app/reveal

cat > app/summary/page.tsx << 'EOT'
"use client";
...
cat > app/reveal/page.tsx << 'EOT'
export default function RevealPage() {
  return (
    <main className="min-h-screen flex items-center justify-center px-6 text-center">
      <div className="space-y-4">
        <h1 className="text-4xl font-bold">Ответы приняты 🎉</h1>
...
echo "OK: summary + sheets submit added"
